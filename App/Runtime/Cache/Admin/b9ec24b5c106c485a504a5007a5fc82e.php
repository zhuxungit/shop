...
<div class="main-div">
    <form action="/Admin/Admin/add" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            <tr>
                <td class="label">管理员名称：</td>
                <td><input type="text" name="admin_name" value="" style="float:left" size="30"/></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="rpassword" value="" size="20"/></td>
            </tr>
