...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/Admin/Goods/update" method="post" name="theForm">
            <!-- 最大文件限制 -->
            ...
            <table width="90%" id="general-table" align="center">
                <tr>
                    ...
                    <td><input type="text" name="goods_name" value="<?php echo ($goodsdata["goods_name"]); ?>" style="float:left" size="30"/></td>
                </tr>
                <tr>
                    <td class="label">
                        <a href="#" title="点击此处查看提示信息"><img src="/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品货号：
                    </td>
                    <td><input type="text" name="goods_sn" value="<?php echo ($goodsdata["goods_sn"]); ?>" size="20"/><span id="goods_sn_notice"></span><br/>
                ...
                <tr>
                    ...
                    <td><input type="text" name="shop_price" value="<?php echo ($goodsdata["shop_price"]); ?>" size="20"/></td>
                </tr>
                <tr>
                    <td class="label">市场售价：</td>
                    <td><input type="text" name="market_price" value="<?php echo ($goodsdata["market_price"]); ?>" size="20"/></td>
                </tr>
            ...
            <table width="90%" id="detail-table" style="display:none">
                <tr>
                    <td><textarea name="goods_desc" id="goods_desc"><?php echo ($goodsdata["goods_desc"]); ?></textarea></td>
                </tr>
            </table>
            ...
            <table width="90%" id="mix-table" style="display:none" align="center">
                <tr>
                    <td class="label"><a href="#" title="点击此处查看提示信息"><img src="/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        库存数量：
                    </td>

                    <td><input type="text" name="goods_number" value="<?php echo ($goodsdata["goods_number"]); ?>" size="20"/>
                </tr>
                <tr>
            ...
            <table width="90%" id="album-table" style="display:none" align="center">
                <?php if($goodsdata["album"] != ''): ?><tr>
                        <td width="100%">
                            <table class="table_a" border="1" width="100%">
                                ...
                                <?php if(is_array($uploadpicsdata)): foreach($uploadpicsdata as $key=>$pic): ?><tr class="picstr">
                                        <td><?php echo ($pic["id"]); ?></td>
                                        <td><img src="/Public/Uploads/<?php echo ($pic["album_ori"]); ?>" height="60" width="60"></td>
                                        <td><img src="/Public/Uploads/<?php echo ($pic["album_thumb"]); ?>" height="40" width="40"></td>
                                        <td><a href="javascript:void(0);" class="del" data-id="<?php echo ($pic["id"]); ?>">删除</a></td>
                ...
                <tr>
                    <td><a href="javascript:void(0)" class="add">[+]</a>上传文件：<input type="file" name="photo[]"/></td>
...
<script>
    ...
    $(function () {
        $('.add').live('click', function () {
            $(this).parents('table').append("<tr><td><a href='javascript:void(0)' class='release'>[-]</a>上传文件：<input type='file' name='photo[]'/></td></tr>");
        })
    ...
    $(function () {
        $('.del').click(function () {
            ...
            _this = $(this);
            $.post('/Admin/Goods/delpics', {'id': id}, function (data) {
                if (data.status == 1) {
                    _this.parents('.picstr').remove();
                }
            }, 'json')
        })
    })
